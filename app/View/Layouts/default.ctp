    ...
    <body class="sidebar-mini skin-green-light">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                echo $this->Html->link($this->Html->tag('span', 'Pet&acute;s zania', array('class'=>'logo-lg') ) . $this->Html->tag('span', 'CC', array('class'=>'logo-mini')), 
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <li>
                       <a href="#">
                          <div class="pull-left">
                    <?php echo $this->Html->image('/dist/img/user3-128x128.jpg', array('class' => 'img-circle', 'alt' => 'User Image')); ?>
                          </div>
                          <h4>
                             Design Team
                    ...
                    <li>
                       <a href="#">
                          <div class="pull-left">
                    <?php echo $this->Html->image('/dist/img/user4-128x128.jpg', array('class' => 'img-circle', 'alt' => 'User Image')); ?>
                          </div>
                          <h4>
                             Developers
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        $menus = array(
                            ...
                            array(
                                'title' => '<i class="fa fa-industry" aria-hidden="true"></i><span>Mascotas</span>',
                                'redirect' => array('controller' => 'Patients', 'action' => 'index'),
                                'normalUser' => 1
                            ),
			    array(
                                'title' => '<i class="fa fa-building" aria-hidden="true"></i><span>Citas</span>',
