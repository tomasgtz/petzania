...
<div class="main">
  ...
  <div>
    ...
    <div class="column-main">
      ...
      <div class="toolbar">
                    <span class="toolbar-item">Visualizar:
...
<script>
  ...
  scheduler.onEventDeleted = function (args) {
    ...
    $.post("delete", JSON.stringify(params), function (data) {
      scheduler.message("Eliminado");
    });
  };
  ...
  scheduler.onTimeRangeSelected = function (args) {
    ...
    $.post("create", JSON.stringify(params), function (data) {
      loadEvents();
  ...
  function loadEvents(day) {
    ...
    $.post("events", JSON.stringify(params), function (data) {
  ...
  $(document).ready(function () {
    ...
    $("#clear").click(function () {
      ...
      $.post("clear", JSON.stringify(params), function (data) {
        dp.message(data.message);
        loadEvents();
      });
    });
